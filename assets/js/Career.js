...
jQuery("#Career").submit(function (e) {
	...
	function valid_contact() {
		...
		var position = document.querySelector('#Career #position');

		var current = document.querySelector('#Career #current');
		...
		if (position.value == '') {
			...
			document.querySelector('#Career #error_data').innerHTML = '* Please Enter Position.';
		...
		if (current.value == '') {
			...
			document.querySelector('#Career #error_data').innerHTML = '* Please Enter current.';
		...
		else { current.style.borderColor = "" }
		if (company.value == '') {

			document.querySelector('#Career #error_data').innerHTML = '* Please Enter company.';
		...
		else { company.style.borderColor = "" }
